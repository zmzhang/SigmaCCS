...
- [Performance on the test set and the external test set with large rotations.ipynb](others/Performance%20on%20the%20test%20set%20and%20the%20external%20test%20set%20with%20large%20rotations.ipynb). Performance of SigmaCCS on the test set and the external test set with different coordinates generated by ETKDG and MMFF94
